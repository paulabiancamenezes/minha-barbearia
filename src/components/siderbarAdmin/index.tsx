...
import { Home, LogOut, PanelBottom, Settings, Users } from "lucide-react";
                    ...
                    <TooltipProvider>
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Link href="/agenda" className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:text-white">
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Link href="/usuarios" className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:text-white">
